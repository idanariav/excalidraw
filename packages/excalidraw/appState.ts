...
> => {
  return {
    ...
    currentItemGradientColor: undefined, //zsviczian
    ...
    gridType: "square" as const, //zsviczian
...
>(config: { [K in keyof T]: K extends keyof AppState ? T[K] : never }) =>
  ...
  currentItemGradientColor: { browser: true, export: false, server: false }, //zsviczian
  ...
  gridType: { browser: true, export: true, server: true }, //zsviczian
